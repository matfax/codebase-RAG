...
class TestAdvanceSearchPrompt:
            ...
            "projects": [
                {
                    ...
                    "collection_details": [
                        {"name": "project_service1_code", "type": "code", "points_count": 1200},
                        {"name": "project_service1_config", "type": "config", "points_count": 300}
                    ]
                },
                {
                    "name": "frontend",
                    ...
                    "collection_details": [
                        {"name": "dir_frontend_code", "type": "code", "points_count": 600},
                        {"name": "dir_frontend_documentation", "type": "documentation", "points_count": 200}
                    ]
                },
                {
                    "name": "api_gateway",
                    ...
                    "collection_details": [
                        {"name": "project_api_gateway_code", "type": "code", "points_count": 2000}
                    ]
                }
            ]
        }
    ...
    def test_build_search_guidance_prompt_standard(self):
        ...
        result = self.prompt._build_search_guidance_prompt(
            query, self.mock_project_data, "hybrid", "standard"
        )
    ...
    def test_build_search_guidance_prompt_brief(self):
        ...
        result = self.prompt._build_search_guidance_prompt(
            query, self.mock_project_data, "semantic", "brief"
        )
        
        # Should contain brief project list format
        assert "Available Projects:" in result
        assert "`service1`, `frontend`, `api_gateway`" in result or all(
            name in result for name in ["service1", "frontend", "api_gateway"]
        )
    ...
    def test_build_search_guidance_prompt_comprehensive(self):
        ...
        result = self.prompt._build_search_guidance_prompt(
            query, self.mock_project_data, "keyword", "comprehensive"
        )
            ...
            "projects": [
                {
                    ...
                    "collection_types": ["code"],
                    "collection_details": [
                        {"name": "project_test_project_code", "type": "code", "points_count": 1000}
                    ]
                }
            ]
        }
