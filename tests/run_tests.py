...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Wave 15.0 Testing Implementation Runner"
    )
    parser.add_argument(
        "--unit", action="store_true",
        help="Run only unit tests (Wave 15.1)"
    )
    parser.add_argument(
        "--integration", action="store_true", 
        help="Run only integration tests (Wave 15.2)"
    )
    parser.add_argument(
