...
class TestSecureCacheOperations:
    ...
    async def test_access_control(self):
        ...
        # Test allowed access
        assert access_control_check(
            security_context,
            resource="cache:tenant456:data",
            action="read"
        ) is True
