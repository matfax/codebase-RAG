...
from utils.workflow_orchestrator import WorkflowOrchestrator, WorkflowState
...
class TestPromptErrorHandler:
    ...
    def test_error_context_manager(self):
        ...
        with pytest.raises(Exception):  # Should re-raise as PromptOperationError
...
class TestMCPPromptsSystem:
    ...
    def setup_method(self):
        ...
        with patch('mcp_prompts.IndexingService'), \
...
class TestMCPPromptsIntegration:
    ...
    def test_full_system_integration(self, mock_embedding, mock_analysis, mock_indexing):
        ...
        prompts_system = MCPPromptsSystem(self.mock_app)
