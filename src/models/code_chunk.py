...
class CodeChunk:
    ...
    # Semantic metadata
    name: Optional[str] = None         # Function name, class name, variable name, etc.
    parent_name: Optional[str] = None  # Parent class or module name for context
    signature: Optional[str] = None    # Function signature, class definition, etc.
    docstring: Optional[str] = None    # Associated documentation string
    
    # Context enhancement
    breadcrumb: Optional[str] = None   # Full hierarchical path (module.class.method)
    context_before: Optional[str] = None  # 5 lines of code before this chunk
    context_after: Optional[str] = None   # 5 lines of code after this chunk
    
    # Processing metadata
    content_hash: Optional[str] = None    # SHA256 hash of the content for change detection
    embedding_text: Optional[str] = None # Optimized text for embedding generation
    indexed_at: Optional[datetime] = None # When this chunk was processed
    
    # Additional metadata for search and retrieval
    tags: List[str] = None             # Additional tags for categorization
    complexity_score: Optional[float] = None  # Estimated complexity (0.0-1.0)
