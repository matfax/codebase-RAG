...
from .prompt_context import PromptContext, PromptResult, PromptType, UserRole, TaskType, DifficultyLevel
from .recommendation import RecommendationSet, RecommendationAction
...
def create_prompt_instance(prompt_type: PromptType) -> Optional[BasePrompt]:
    """
