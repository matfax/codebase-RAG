...
class TestTreeSitterManager:
    ...
    def test_get_supported_languages(self):
        ...
        expected_languages = {'python', 'javascript', 'typescript', 'tsx', 'go', 'rust', 'java'}
    ...
    def test_get_initialization_summary(self):
        ...
        required_keys = [
            'total_languages', 'successful_languages', 'failed_languages',
            'success_rate', 'supported_languages', 'failed_languages',
