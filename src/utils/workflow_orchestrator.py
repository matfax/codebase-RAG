...
from models.prompt_context import (
    PromptContext, PromptResult, WorkflowState, PromptType,
    UserRole, TaskType, DifficultyLevel
)
from models.recommendation import (
    RecommendationSet, RecommendationAction, RecommendationType,
...
class WorkflowOrchestrator:
    ...
    def create_workflow(
        ...
        initial_context: Optional[PromptContext] = None
    ) -> WorkflowState:
        """
    ...
    def execute_prompt_with_workflow(
        ...
        **kwargs
        ...
        try:
            ...
            self.logger.info(f"Executed prompt {prompt_type.value} in workflow {workflow_id}, "
    ...
    def _initialize_workflow_templates(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "project_exploration": {
                ...
                "initial_state": {
                    "exploration_goals": ["understand_architecture", "identify_components", "map_dependencies"]
                }
            },
            "component_deep_dive": {
                ...
                "initial_state": {
                    "analysis_goals": ["understand_purpose", "analyze_interface", "trace_usage"]
                }
            },
            "functionality_tracing": {
                ...
                "initial_state": {
                    "tracing_goals": ["map_call_chain", "understand_data_flow", "identify_config"]
                }
            }
        }
    ...
    def _estimate_remaining_time(self, workflow: WorkflowState, context: PromptContext) -> Optional[int]:
