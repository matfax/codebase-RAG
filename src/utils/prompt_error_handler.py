...
from models.prompt_context import PromptContext, PromptResult, PromptType
...
class PromptErrorHandler:
    ...
    def get_error_context(self, error_id: str) -> Optional[PromptError]:
    ...
    def get_error_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "recent_error_types": [
                error.category.value for error in self.stats.recent_errors[-10:]
            ]
        }
    ...
    def _analyze_recovery_options(self, error: PromptError, exception: Exception):
        ...
        error.suggested_fixes = recovery_suggestions.get(error.category, [
    ...
    def _update_error_stats(self, error: PromptError):
        ...
        self.stats.errors_last_hour = len([
            e for e in self.stats.recent_errors 
            if e.timestamp >= hour_ago
        ])
        
        self.stats.errors_last_day = len([
            e for e in self.stats.recent_errors 
