...
class LanguageMetadata:
    ...
    def __post_init__(self):
        ...
        if not self.supported_chunk_types:
            ...
            chunk_types = {ChunkType.FUNCTION, ChunkType.IMPORT, ChunkType.CONSTANT, ChunkType.VARIABLE}
...
class LanguageRegistry:
    ...
    def _initialize_builtin_languages(self) -> None:
        ...
        python_caps = LanguageCapabilities(
            functions=True, classes=True, decorators=True, modules=True,
            static_typing=False, dynamic_typing=True, type_hints=True,
            docstrings=True, inline_docs=True, exceptions=True,
            automatic_memory=True, garbage_collection=True
        )
        self.register_language(LanguageMetadata(
            name="python",
            display_name="Python",
            paradigms=[LanguageParadigm.OBJECT_ORIENTED, LanguageParadigm.SCRIPTING],
        ...
        js_caps = LanguageCapabilities(
            functions=True, classes=True, modules=True,
            static_typing=False, dynamic_typing=True,
            docstrings=False, inline_docs=True, exceptions=True,
            automatic_memory=True, garbage_collection=True
        )
        self.register_language(LanguageMetadata(
            name="javascript",
            display_name="JavaScript",
            paradigms=[LanguageParadigm.OBJECT_ORIENTED, LanguageParadigm.FUNCTIONAL, LanguageParadigm.SCRIPTING],
            complexity=LanguageComplexity.MODERATE,
        ...
        ts_caps = LanguageCapabilities(
            functions=True, classes=True, interfaces=True, modules=True,
            static_typing=True, dynamic_typing=False, type_inference=True,
            annotations=True, docstrings=False, inline_docs=True,
            exceptions=True, automatic_memory=True, garbage_collection=True
        )
        self.register_language(LanguageMetadata(
            name="typescript",
        ...
        go_caps = LanguageCapabilities(
            functions=True, classes=False, interfaces=True, modules=True,
            static_typing=True, type_inference=True,
            docstrings=False, inline_docs=True, exceptions=False,
            error_propagation=True, automatic_memory=True, garbage_collection=True
        )
        self.register_language(LanguageMetadata(
            name="go",
            display_name="Go",
        ...
        rust_caps = LanguageCapabilities(
            functions=True, classes=False, modules=True,
            static_typing=True, type_inference=True, generics=True,
            macros=True, annotations=True, docstrings=False, inline_docs=True,
            exceptions=False, error_propagation=True,
            automatic_memory=False, manual_memory=True
        )
        self.register_language(LanguageMetadata(
            name="rust",
            display_name="Rust",
        ...
        java_caps = LanguageCapabilities(
            functions=True, classes=True, interfaces=True,
            static_typing=True, annotations=True, generics=True,
            docstrings=False, inline_docs=True, exceptions=True,
            automatic_memory=True, garbage_collection=True
        )
        self.register_language(LanguageMetadata(
        ...
        cpp_caps = LanguageCapabilities(
            functions=True, classes=True, namespaces=True,
            templates=True, static_typing=True,
            macros=True, inline_docs=True,
            exceptions=True, automatic_memory=False, manual_memory=True
        )
        self.register_language(LanguageMetadata(
            name="cpp",
            display_name="C++",
    ...
    def get_language(self, name: str) -> Optional[LanguageMetadata]:
        """
    ...
    def detect_language_from_extension(self, file_path: str) -> Optional[str]:
        """
    ...
    def get_languages_by_paradigm(self, paradigm: LanguageParadigm) -> List[str]:
        ...
        """
        return [
            name for name, metadata in self._languages.items()
            if paradigm in metadata.paradigms
        ]
    ...
    def get_language_capabilities(self, name: str) -> Optional[LanguageCapabilities]:
        """
    ...
    def get_tree_sitter_config(self, name: str) -> Optional[Dict[str, str]]:
        """
