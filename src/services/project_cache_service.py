...
class ProjectCacheService:
    ...
    def __init__(self, config: CacheConfig | None = None):
        ...
        self._cache_service: Optional[BaseCacheService] = None
        self._key_generator: Optional[CacheKeyGenerator] = None
    ...
    async def get_project_metadata(self, project_path: str) -> Optional[ProjectMetadata]:
        """
    ...
    async def cache_project_detection(
        self, 
        directory: str, 
    ...
    async def get_project_detection(self, directory: str) -> Optional[ProjectDetectionResult]:
        """
    ...
    async def cache_collection_mapping(
        self, 
        project_id: str, 
    ...
    async def get_collection_mapping(self, project_id: str) -> Optional[CollectionMapping]:
        """
    ...
    async def cache_file_filtering_result(
        self, 
        directory: str, 
    ...
    async def get_file_filtering_result(self, directory: str) -> Optional[FileFilteringResult]:
        """
    ...
    async def cache_project_statistics(
        self, 
        project_id: str, 
    ...
    async def invalidate_project_cache(self, project_id: str) -> bool:
        ...
        try:
            ...
            if keys_to_invalidate:
                ...
                self.logger.info(
                    f"Invalidated {success_count}/{len(keys_to_invalidate)} cache entries for project: {project_id}"
                )
    ...
    async def invalidate_directory_cache(self, directory: str) -> bool:
        ...
        try:
            ...
            self.logger.info(
                f"Invalidated {success_count} cache entries for directory: {directory_path}"
            )
