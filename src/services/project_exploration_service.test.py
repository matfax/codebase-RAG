...
from services.project_exploration_service import (
    ProjectExplorationService, ProjectExplorationResult
)
...
class TestEnhancedProjectExplorationService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_rag_results = {
            ...
            "component_relationships": {
                ...
                "relationships": [
                    {
                        "component1": {"name": "UserService", "file_path": "src/services/user_service.py"},
                        "component2": {"name": "UserRepository", "file_path": "src/repositories/user_repository.py"},
    ...
    def test_explore_project_with_rag(self, mock_rag_analysis, mock_components, mock_architecture, mock_basic):
        ...
        # Execute exploration
        result = self.service_with_rag.explore_project(
    ...
    def test_explore_project_without_rag(self, mock_components, mock_architecture, mock_basic):
        ...
        # Execute exploration
        result = self.service_without_rag.explore_project(
            project_path="/test/project",
            detail_level="comprehensive"
        )
    ...
    def test_integrate_rag_results(self):
        ...
        self.assertEqual(result.rag_architecture_analysis, self.mock_rag_results["architecture_analysis"])
        self.assertEqual(result.rag_component_relationships, self.mock_rag_results["component_relationships"])
    ...
    def test_enhance_learning_recommendations_with_rag(self):
        ...
        self.assertIn("Study MVC architecture pattern implementation", result.key_concepts_to_understand)
        ...
        self.assertIn("Service-Repository pattern detected in component relationships", result.coding_patterns)
    ...
    def test_rag_analysis_detail_levels(self):
        ...
        result_overview = self.service_with_rag._perform_rag_analysis(
            project_path=Path("/test/project"),
            focus_area=None,
        ...
        result_comprehensive = self.service_with_rag._perform_rag_analysis(
            project_path=Path("/test/project"),
            focus_area=None,
            detail_level="comprehensive"
        )
