...
def clear_project_data(project_name: Optional[str] = None, directory: str = ".") -> Dict[str, Any]:
    """
...
def clear_project_data_sync(project_name: Optional[str] = None, directory: str = ".") -> Dict[str, Any]:
...
def register_project_tools(mcp_app: FastMCP):
    ...
    @mcp_app.tool()
    def clear_project_data_tool(project_name: Optional[str] = None, directory: str = ".") -> Dict[str, Any]:
        """
        Clear all indexed data for a project.
