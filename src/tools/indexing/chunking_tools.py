    ...
    with log_tool_usage("get_chunking_metrics", {"language": language, "export_path": bool(export_path)}):
        try:
            ...
            if language:
                ...
                logger.info(f"Retrieved metrics for {language}: "
                ...
                logger.info(f"Retrieved comprehensive chunking metrics: "
...
def get_chunking_metrics_sync(language: Optional[str] = None, export_path: Optional[str] = None) -> Dict[str, Any]:
...
def register_chunking_tools(mcp_app: FastMCP):
    ...
    @mcp_app.tool()
    def get_chunking_metrics_tool(language: Optional[str] = None, export_path: Optional[str] = None) -> Dict[str, Any]:
        """
        Get comprehensive chunking performance metrics.
