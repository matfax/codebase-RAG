...
def register_tools(mcp_app: FastMCP) -> None:
    ...
    async def index_directory(
        ...
        """
        return await index_directory_impl(
            directory, patterns, recursive, 
            clear_existing, incremental, project_name
        )
    ...
    async def warm_cache_for_project_tool(
        ...
        """
        return await warm_cache_for_project(
            project_name, cache_types, 
            warmup_strategy, max_concurrent
        )
    ...
    async def optimize_cache_performance_tool(
        ...
        """
        return await optimize_cache_performance(
            optimization_type, 
            apply_changes, project_name
        )
    ...
    if env == 'development':
        ...
        async def manual_invalidate_file_cache_tool(
            ...
            return await manual_invalidate_file_cache(
                file_path, reason, cascade, use_partial, old_content, 
        ...
        async def manual_invalidate_project_cache_tool(
            ...
            """
            return await manual_invalidate_project_cache(
                project_name, reason, invalidation_scope, strategy
            )
        ...
        async def manual_invalidate_cache_keys_tool(
            ...
            Returns:
                Dictionary with invalidation results and statistics
            """
            return await manual_invalidate_cache_keys(cache_keys, reason, 
            cascade)
        ...
        async def inspect_cache_state_tool(
            ...
            Returns:
                ...
                health
            """
            return await inspect_cache_state(cache_type, include_content, 
            max_entries)
        ...
        async def preload_embedding_cache_tool(
            ...
            """
            return await preload_embedding_cache(
        ...
        async def get_comprehensive_cache_stats_tool(
            ...
            Returns:
                ...
                metrics
            """
            return await get_comprehensive_cache_stats(
                project_name, 
                include_historical, 
                time_range_hours
            )
        ...
        async def generate_cache_report_tool(
            ...
            Returns:
                ...
                recommendations
            """
            return await generate_cache_report(
                report_type, 
                project_name, 
                export_format
            )
        ...
        async def update_cache_configuration_tool(
            ...
            """
            return await update_cache_configuration(
                config_updates, 
                validate_only, 
                restart_services
            )
        ...
        async def export_cache_configuration_tool(
            ...
            """
            return await export_cache_configuration(
                export_path, 
                config_type, 
                include_sensitive
            )
        ...
        async def import_cache_configuration_tool(
            ...
            """
            return await import_cache_configuration(
                import_path, 
                config_type, 
                validate_only, 
                backup_current
        ...
        async def configure_cache_alerts_tool(
            ...
            """
            return await configure_cache_alerts(
                alert_config, 
                enable_alerts
            )
        ...
        async def backup_cache_data_tool(
            ...
            """
            return await backup_cache_data(
                backup_path, 
                backup_type, 
                include_services, 
                compression
        ...
        async def restore_cache_data_tool(
            ...
            """
            return await restore_cache_data(
                backup_path, 
                restore_type, 
                target_services, 
                validate_only
        ...
        async def migrate_cache_data_tool(
            ...
            """
            return await migrate_cache_data(
                migration_type, 
                source_config, 
                target_config, 
                dry_run
