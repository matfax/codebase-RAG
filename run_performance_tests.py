...
async def run_cache_performance_benchmarks():
    ...
    try:
        ...
        try:
            ...
            result = await benchmark_suite.benchmark_basic_operations(search_cache, iterations=100, data_sizes=[100, 1000, 10000])
        ...
        try:
            ...
            load_result = await benchmark_suite.benchmark_concurrent_load(
                project_cache, concurrent_operations=50, operations_per_worker=20, data_size_bytes=1024
            )
        ...
        try:
            memory_result = await benchmark_suite.benchmark_memory_usage(
                cache_config, operations=["set", "get", "delete"], data_sizes=[1024, 10240, 102400], iterations=50
            )
